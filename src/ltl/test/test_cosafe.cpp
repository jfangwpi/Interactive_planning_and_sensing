/*** This file tests the LTL specification with co-safe feature ***/
/*** co-safe: if target is found, move to another target. ***/
/*** co-safe: eventually move to certain location ***/
...
{
    //======================================== SET GRID MAP =======================================//
	std::shared_ptr<SquareGrid> grid = GridGraph::CreateSquareGrid(10,10,1);
