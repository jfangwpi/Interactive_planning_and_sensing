/*** This file tests the route planning for vehicles with different radius of turning ***/
// standard libaray
#include <stdio.h>
#include <vector>
#include <ctime>
...
int main(int argc, char** argv )
{
	...
	std::shared_ptr<SquareGrid> grid = GridGraph::CreateSquareGrid(row_num,col_num,1);
