...
private:
	...
	static cv::Scalar v4_color_; 		// vehilce 4 cell color
	static cv::Scalar v5_color_; 		// vehicle 5 cell color
	static cv::Scalar v6_color_; 		// vehilce 6 cell color
	static cv::Scalar v7_color_; 
	static cv::Scalar v8_color_; 		// vehilce 8 cell color
	static cv::Scalar v9_color_; 
	static cv::Scalar v10_color_;
	static cv::Scalar v11_color_;
	static cv::Scalar v12_color_;
	static cv::Scalar v13_color_;
