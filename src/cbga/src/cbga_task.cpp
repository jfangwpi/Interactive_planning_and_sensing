...
cbga_Task::cbga_Task(int64_t id, std::vector<int64_t> pos, TasksType type, int64_t num_agents, std::string liveness, std::string safety, std::vector<std::string> buchi_regions):
idx_(id),
pos_(pos),
type_(type),
