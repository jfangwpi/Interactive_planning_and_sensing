...
const float cbga_benefit = 1000.0;
    ...
    class cbga_Task{
        ...
        public:
            cbga_Task(int64_t id, std::vector<int64_t> pos, TasksType type, int64_t num_agents, std::string liveness, std::string safety, std::vector<std::string> buchi_regions);
