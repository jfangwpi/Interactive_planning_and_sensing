...
/*** This file test the Kth closest agent for certain task with given reward_matrix ***/
// standard libaray
#include <stdio.h>
#include <vector>
#include <ctime>
...
int main(int argc, char** argv )
{
	...
	/*** 4. Initialize agents ***/
	std::vector<Agent> agents_group = {Agent(0, 1, 10, 0, 6),Agent(1, 10, 10, 0, 6),Agent(2, 12, 10, 0, 6),
		Agent(3, 14, 10, 0, 6), Agent(4, 20, 10, 0, 6),Agent(5, 22, 10, 0, 6)};
