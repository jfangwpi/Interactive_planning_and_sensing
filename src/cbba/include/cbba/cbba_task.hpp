...
class LTLFormula{
	...
	public:
		...
		std::map<int, TasksType> task_type_;
...
void get_tasks_properties(LTLFormula& formula, std::map<int, TasksType> task_info);
void set_tasks_details(LTLFormula& formula);
    ...
    class cbba_Task{
        ...
        public:
            cbba_Task(int64_t id, std::vector<int64_t> pos, TasksType type, int64_t num_agents, std::string liveness, std::string safety, std::vector<std::string> buchi_regions);
    ...
    class TasksList{
        ...
        public: 
            ...
            TasksList(std::vector<int64_t> hotspots){SetTasksFromHotSpots(hotspots);};
            TasksList(){};
        ...
        public:
            ...
            void SetTasksFromHotSpots(std::vector<int64_t> hotspots);
    };
}
